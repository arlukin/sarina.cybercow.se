...
public class Thread1 implements Runnable {
	...
	/* Skapar en instans av Thread1 som har en sträng
	 ...
	 */
	public Thread1(String txt, long time, JTextArea ar) {
		text = txt;
		interval = time*1000;
		area = ar;
	}
	...
	public void stopIt() {
     ...
     /*
      * Kör tråden Thread1 samt skriver ut
