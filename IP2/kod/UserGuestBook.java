/*
 * @UserGuestBook.java 1.0 03/11/12
 *
 */
...
/*
 * Användarens personliga gästbok.
 *
 * @version 	1.0 12 November 2003
 * @author 	Carina Nerén
 */
public class UserGuestBook extends CacheHttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		handleForm(guestUserName, comment, userName, out);
	...
	private void printMessages(PrintWriter out, String userName) {
		...
		try {
			...
			e.printStackTrace();out.println("i printmessages catch");
		} finally {
			try {
	...
	public String checkTags(String str) {
 	  ...
 	  */
  	public void handleForm(String guestUserName, String comment, String userName, PrintWriter out) {
		Connection dbConnection = null;
      	Statement stmt = null;
