...
/**
  * Visar besökarens väns egna sida med personlig information.
  * Denna sida kan inte besökaren ändra något i utan bara navigera.
  *
...
public class ViewFriend extends CacheHttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
  	...
  	/** Hämtar värdet från den specifika paramatern samt anropar doPost. */
	  ...
	  * användaren samt skriver ut den personliga sidan.
  	  */
