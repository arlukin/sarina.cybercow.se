 ...
 * på serversidan. Värdet sänds som HTML till användaren.
 *
 * @version 	1.0 12 November 2003
 * @author 	Carina Nerén
 */
public class Ass01c extends HttpServlet {
    ...
    public void init() throws ServletException {
		if(htmlTemplate == null) {
			htmlTemplate = Mixer.getContent(new File(getServletContext().getRealPath("Ass01c.html")));
		}
    ...
    /* Skriver ut antalet besökare på sidan till den hämtade HTML-filen.*/
