...
/*
 * Ändrar användarens information.
 *
...
public class ChangeUserInfo extends CacheHttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
  	...
  	/*
  	 * Skriver ut formuläret där använderen kan ändra sin information om sig själv.
  	 */
	...
	public String checkTags(String str) {
 	 ...
 	 /*
 	  * Uppdaterar databasen med användarens information.
 	  */
